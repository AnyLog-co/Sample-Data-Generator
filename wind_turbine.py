...
def generate_windturbine_data():
    """
    The following extracts wind turbine data from USGS to either be stored in AnyLog (via POST or PUT) or print results.
    :links:
        docs: https://eerscmap.usgs.gov/uswtdb/api-doc/
        dataset: https://eersc.usgs.gov/api/uswtdb/v1/turbines
    :data conversion:
        Data provided from USGS: {'case_id': 3072661, 'faa_ors': None, 'faa_asn': None, 'usgs_pr_id': 5149, 't_state': 'CA', 't_county': 'Kern County', 't_fips': '6029', 'p_name': '251 Wind', 'p_year': 1987, 'p_tnum': 194, 'p_cap': 18.43, 't_manu': 'Vestas', 't_model': None, 't_cap': 95, 't_hh': None, 't_rd': None, 't_rsa': None, 't_ttlh': None, 't_conf_atr': 2, 't_conf_loc': 3, 't_img_date': '5/8/2018', 't_img_srce': 'Digital Globe', 'xlong': -118.36376, 'ylat': 35.07791, 'eia_id': 52161, 'retrofit': 0, 'retrofit_year': None}
        Data Stored in AnyLog / print: {'timestamp': '1987-02-16 10:56:01.632841', 'usgs_pr_id': 5149, 'address': 'Kern County, CA', 'loc': '35.07791, -118.36376', 'p_name': '251 Wind', 'p_tnum': 194, 'p_cap': 18.43, 't_manu': 'Vestas', 't_model': None, 't_cap': 95, 't_hh': None, 't_rd': None, 't_rsa': None, 't_ttlh': None, 'retrofit': 0, 't_conf_atr': 2, 't_conf_loc': 3, 'eia_id': 52161}
    :sample-outup:
