...
def main(conn:RestClient|None, broker:str, port:int, user:str=None, password:str=None, is_rest:bool=False):
    ...
    declare_msg_client(conn=conn, broker=broker, port=port, user=user, password=password, is_rest=is_rest,
